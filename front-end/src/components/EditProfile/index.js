    ...
    <div className="editProfile__container">
      <form onSubmit={onEditProfileSubmit} method="patch">
        ...
        <div className="editProfile__mainInfos">
          ...
          <div>
            <label>Prénom</label>
            <input onChange={handleChange} value={firstname || ''} name="firstname" type="text" className=" input" placeholder={firstname || 'Prénom'} required />
          </div>

          <div>
            <label>Age</label>
            <input onChange={handleChange} value={age || ''} name="age" type="number" className=" input" placeholder={age || 'Votre âge'} />
          </div>
        ...
        <div className="editProfile__textArea">
          ...
          <div>
            ...
            <input onChange={handleChange} name="portfolio" type="text" className="editProfile__link input" value={portfolio || ''} placeholder={portfolio || 'Lien vers votre book, votre bande-démo, etc...'} />
          </div>
        </div>
      </form>
    </div>
