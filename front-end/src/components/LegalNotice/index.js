  ...
  <div className="legalNotice__container">
    ...
    <article className="legalNotice__article">
      ...
      <p className="legalNotice__pArticle"><strong>01234567891011 </strong>au capital de<strong> </strong><strong>80000 </strong>€   Tél: <strong>0102030405</strong>
        ...
        Numéro TVA intracommunautaire : <strong>3244322</strong><br />Adresse de courrier électronique : <strong>allo@allocrew.fr</strong> <br /> <br />Directeur de la  publication : <strong>Allo Crew</strong><br />Contactez le responsable de la publication : <strong>allo@AlloCrew.fr</strong>
      </p>
    </article>
  </div>
);
