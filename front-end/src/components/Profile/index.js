...
const Profile = ({
  id, age, location, firstname, lastname, title, description, experience, portfolio, picture, bannerpicture,
}) => (
  <div className="profile__container">
    <div className="profile__pict">
      <div className="profile__pict__cover" style={{ backgroundImage: `url(${bannerpicture})` }} />
      <div className="profile__pict__profile" style={{ backgroundImage: `url(${picture})` }} />
    </div>
