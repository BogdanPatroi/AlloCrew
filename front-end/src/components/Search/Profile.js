...
const SearchProfile = (profile, {
  id, lastname, firstname, title, picture, bannerpicture,
}) => (
  ...
  <div className="searchProfiles">
    <Link to={`/profile/${profile.id}`}>
      <div className="searchProfile searchProfile--1">
        ...
        <div className="searchProfile__img" style={profile.bannerpicture ? { backgroundImage: `url(${profile.bannerpicture})` } : { backgroundImage: `url(${bg})` }} />
