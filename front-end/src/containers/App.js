...
import {
  checkAuth, setUserParams, updateAnnouncement, clearNotification, changeEmail, changePassword, dispatchSocket,
} from '../Redux/actions';
...
const mapDispatchToProps = (dispatch) => ({
  ...
  closeParams: () => {
    dispatch(setUserParams(false)), dispatch(clearNotification());
  },
  ...
  dispatchSocket: (data) => dispatch(dispatchSocket(data)),
});
