...
import {
  inputCreateAnnouncement, fetchAnnouncement, postCreateAnnouncement, patchEditAnnouncement,
} from '../Redux/actions';
...
const mapDispatchToProps = (dispatch, { match }) => ({
  ...
  handleChecked: (e) => {
    if (e.target.checked && e.target.value == ('paid')) {
  ...
  onCreateAnnouncementSubmit: (e) => {
    e.preventDefault(); dispatch(postCreateAnnouncement());
  },
  onEditAnnouncementSubmit: (e) => {
    e.preventDefault(); dispatch(patchEditAnnouncement(match.params.id));
  },
